...
{#if isOpen}
	...
	>
		<!-- Modal Content -->
		<div
			class="bg-white rounded-md shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col"
				...
				<div class="flex items-center justify-between gap-4">
					...
					<div class="flex gap-3">
						...
						<button
							...
							class="px-6 py-2.5 rounded-lg text-sm font-medium text-white bg-teal-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
						>
							Confirm Location
						</button>
					</div>
