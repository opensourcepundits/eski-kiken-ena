<script lang="ts">
	...
	let { data } = $props();
	let { user, userListings, userBookings, ownerBookings } = data;
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
								{#each userListings as listing}
									...
									>
										...
										<div class="p-8">
											<h3 class="text-xl font-black text-slate-900 mb-2 truncate">
												{listing.title}
											</h3>
											...
											<div class="flex gap-3">
												<div class="flex-1 bg-slate-50 p-4 rounded-2xl text-center">
													...
													<p class="text-xs font-black text-emerald-600">Active</p>
												</div>
												<div class="flex-1 bg-slate-50 p-4 rounded-2xl text-center">
													<p
														class="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1"
